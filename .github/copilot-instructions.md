...
1. Collects all known JDK `bin` directories from config
2. Removes entries matching `%JAVA_HOME%\bin` or `%JAVA_HOME%/bin` patterns
3. Prepends the new bin directory
